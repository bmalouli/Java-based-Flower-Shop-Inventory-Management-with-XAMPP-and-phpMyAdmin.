        ...
        btnSupprimer.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (fleur != null) {
                    ...
                    JOptionPane.showMessageDialog(null, "Aucune fleur trouvée avec l'ID " + textField.getText(),
                            "Fleur introuvable", JOptionPane.WARNING_MESSAGE);
                }
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (fleur != null) {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "La fleur avec l'Id " + idChoisi + " a été supprimée avec succès.", "Suppression réussie",
                            JOptionPane.INFORMATION_MESSAGE);
                    videInfos();
                } else {
                    JOptionPane.showMessageDialog(null, "Aucune fleur trouvée avec l'ID " + idChoisi,
                            "Fleur introuvable", JOptionPane.WARNING_MESSAGE);
                }
            }
        });
