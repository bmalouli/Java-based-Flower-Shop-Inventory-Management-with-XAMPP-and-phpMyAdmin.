...
public class RechercherFleurFrame extends JFrame {
    ...
    public RechercherFleurFrame() {
        ...
        lblNom.setBounds(173, 294, 100, 16);
        ...
        btnRechercherSelonNom.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                fleur = CtrI.CtrI_GetByName(textField_1.getText());
                if (nomCheckBox.isSelected()){
                    lblId.setText(Integer.toString(fleur.getId()));
                    lblNom.setText(fleur.getName());
                    lblCouleur.setText(fleur.getColor());
                    lblPrix.setText(Integer.toString(fleur.getPrice()));
                    lblQuantite.setText(Integer.toString(fleur.getQuantity()));
                }
            }
        });
